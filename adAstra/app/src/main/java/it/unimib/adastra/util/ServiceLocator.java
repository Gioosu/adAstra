...
import it.unimib.adastra.data.repository.ISSPosition.ISSPositionRepository;
...
public class ServiceLocator {
    ...
    public IISSPositionRepository getISSRepository(Application application) {
        ...
        return new ISSPositionRepository(issPositionRemoteDataSource, issPositionLocalDataSource);
    }
